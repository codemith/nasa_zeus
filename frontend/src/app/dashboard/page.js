    ...
    return (
        <AuthGuard>
            ...
            <main className="relative h-screen w-screen overflow-hidden">
                ...
                <div className="absolute bottom-4 left-4 z-[1001] w-[400px]">
                    <div className="bg-gray-900/20 backdrop-blur-sm rounded-lg shadow-2xl border border-white/20 p-5">
                        {/* Location Info */}
                        ...
                        <div>
                            ...
                            {alerts.length > 0 && alerts[0].aqi_current ? (
                                <div className="text-center">
                                    <div className="text-5xl font-bold text-white mb-2">
                                        {alerts[0].aqi_current}
                                    </div>
                                    ...
                                    <div className="w-full bg-gradient-to-r from-green-400 via-yellow-400 via-orange-400 via-red-400 to-purple-600 h-3 rounded-full mb-2">
                                        <div
                                            ...
                                            style={{
                                                width: `${(alerts[0].aqi_current / 5) * 100}%`,
                                                maxWidth: '100%'
                                            }}
                                        ></div>
                                    </div>
                ...
                {/* Gemini Weather Agent Widget - Below Location Panel */}
                <div className="absolute bottom-4 right-4 z-[1001] w-[400px]">
